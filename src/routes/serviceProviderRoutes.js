...
router.put('/enquiry/:id/approve', ServiceProviderEnquiryController.approveEnquiry);
...
router.put('/providers/:id/status', ServiceProviderController.updateProviderStatus);
router.put('/providers/:id/categories', ServiceProviderController.updateServiceCategories);

// Employee routes
router.get('/providers/:providerId/employees', ServiceProviderEmployeeController.getAllEmployees);
router.post('/providers/:providerId/employees', ServiceProviderEmployeeController.addEmployee);
