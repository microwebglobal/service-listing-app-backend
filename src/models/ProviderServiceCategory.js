...
module.exports = (sequelize, DataTypes) => {
  ...
  ProviderServiceCategory.init(
    {
      ...
      service_id: {
        ...
        comment:
          "If set, provider is only approved for this specific service in the category",
      },
      item_id: {
        type: DataTypes.STRING,
        allowNull: true,
        ...
        comment:
          "If set, provider is only approved for this specific service item",
      },
      experience_years: {
        type: DataTypes.INTEGER,
        allowNull: false,
      ...
      price_adjustment: {
        ...
        allowNull: true,
        comment:
          'Optional price adjustments {type: "multiplier|fixed", value: number}',
        validate: {
  ...
  ProviderServiceCategory.prototype.canProvideService = function (
    serviceId,
    itemId
  ) {
